...
public class UnitTest
{
    ...
    public void ProductList_ShouldExecuteSuccessullyAndReturnProducts()
    {
        ...
        var productController = new ProductControllerTest(productService.Object);
    ...
    public void Product_GetProductByIdWithInvalıdArguments_ThrowsArgumentException()
    {
        ...
        var productService = new Mock<IProductService>();
        var productList = GetProducts();
        productService.Setup(product => product.GetByIdAsync(8))
            .ReturnsAsync(productList[1]);
    ...
    [Fact]
    public void Product_GetProductByIdNullArguments_ThrowsNullReferenceException()
    {
        //arrange
        var productService = new Mock<IProductService>();
